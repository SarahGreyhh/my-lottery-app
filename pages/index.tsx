...
const Home: NextPage = () => {
  ...
  try {
    const data= await BuyTickets
     ...
     toast.success("Tickects purchased successfuly", {
        id:notification,
     });
  ...
  return (
    <div className="bg-[#2563EB] min-h-screen
     flex flex-col ">
      ...
      {/* The Next Draw Box */}
      <div className='space-y-5 md:space-y-0 m-5 md:flex-row 
      items-start justify-center md:space-x-5' > 
        ...
        <div className='flex justify-between p-2 space-x-2' >
          <div className='stats' >
            <h2 className='text-sm' >Total Poool</h2>
            <p  className='text-xl' >
              {currentWinningReward &&
         ...
         <div className="stats-container space-y-2">
          <div className="stats-container">
            ...
            <div className='flex text-white items-center space-x-2 bg-[#2563EB]
            border-[#7aa3fc] p-4 ' >
              <p>TICKETS</p> 
            ...
            onClick={handleClick}
             ...
             from-blue-300 to-blue-600 first-letter:py-5 rounded-md
             text-white shadow-xl disabled:from-gray-600
             disabled:to-gray-200 disabled:cursor-not-allowed
