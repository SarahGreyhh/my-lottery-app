...
function CountdownTimer() {
    const {contract} = useContract (
     ...
     const renderer = ({ hours, minutes, seconds, completed }: Props ) => {
        if (completed) {
            return (
            <div><h2 className='text-white text-xl text-center animate-bounce'>
             ...
             return (
            <div>
                <h3 className='text-white text-sm mb-2 italic'>Time Remaining
                </h3>
                <div className='flex space-x-6' >
                    <div className='flex-1' >
                        <div className='countdown animate' >{hours}</div>
                        <div className='countdown-label' >hours</div>
                    </div>
